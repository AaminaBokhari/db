...
{
    public class VendorLoginForm : BaseForm
    {
        ...
        private void LoginButton_Click(object sender, EventArgs e)
        {
            if (ValidateLogin())
            {
                VendorDashboardForm dashboard = new VendorDashboardForm();
                this.Hide();
        ...
        {
            VendorRegistrationForm registrationForm = new VendorRegistrationForm();
