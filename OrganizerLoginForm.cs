...
{
    public class OrganizerLoginForm : BaseForm
    {
        ...
        private void LoginButton_Click(object sender, EventArgs e)
        {
            if (ValidateLogin())
            {
                OrganizerDashboardForm dashboard = new OrganizerDashboardForm();
                this.Hide();
        ...
        {
            OrganizerRegistrationForm registrationForm = new OrganizerRegistrationForm();
